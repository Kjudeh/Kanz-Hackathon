...
const LOGO = "https://raw.githubusercontent.com/Kjudeh/Kanz-Hackathon/main/dashboard/assets/naatiq-mark.png";
...
<body>
  ...
  <div class="footer"><img class="foot-logo" src="${LOGO}" /><span>{{FOOTER}}</span></div>
</body>
</html>`;
